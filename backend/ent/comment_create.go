...
func (_c *CommentCreate) SetDocumentID(id int) *CommentCreate {
	_c.mutation.SetDocumentID(id)
	return _c
}

// SetDocument sets the "document" edge to the Document entity.
func (_c *CommentCreate) SetDocument(v *Document) *CommentCreate {
...
func (_c *CommentCreate) check() error {
	...
	if len(_c.mutation.DocumentIDs()) == 0 {
		return &ValidationError{Name: "document", err: errors.New(`ent: missing required edge "Comment.document"`)}
	}
	return nil
}
...
func (_c *CommentCreate) createSpec() (*Comment, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.DocumentIDs(); len(nodes) > 0 {
		...
		_node.document_comments = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
