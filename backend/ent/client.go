...
import (
	...
	"github.com/shirone-platform/backend/ent/migrate"
...
// QueryDocument queries the document edge of a Comment.
func (c *CommentClient) QueryDocument(_m *Comment) *DocumentQuery {
...
// QueryAuthor queries the author edge of a Document.
func (c *DocumentClient) QueryAuthor(_m *Document) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
// QueryComments queries the comments edge of a Document.
func (c *DocumentClient) QueryComments(_m *Document) *CommentQuery {
	query := (&CommentClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
